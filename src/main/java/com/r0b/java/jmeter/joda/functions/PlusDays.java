 ...
 */
public class PlusDays extends AbstractFunction {

    private static final Logger LOG = LoggingManager.getLoggerForClass();

    private static final String KEY = "__PlusDays";
    ...
    public List<String> getArgumentDesc() {
        return Arrays.asList("Date string format (yyyy-MM-dd)","Number of days to add");
    }
}
