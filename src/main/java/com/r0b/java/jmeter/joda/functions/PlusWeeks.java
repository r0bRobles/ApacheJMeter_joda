 ...
 */
public class PlusWeeks extends AbstractFunction {

    private static final Logger LOG = LoggingManager.getLoggerForClass();

    private static final String KEY = "__PlusWeeks";
    ...
    public String execute(SampleResult sampleResult, Sampler sampler) throws InvalidVariableException {
        ...
        return date.plusWeeks(weeks).toString();
    }
    ...
    public List<String> getArgumentDesc() {
        return Arrays.asList("Date string format (yyyy-MM-dd)", "Number of weeks to add");
    }
}
