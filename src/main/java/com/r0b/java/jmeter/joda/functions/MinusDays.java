 ...
 */
public class MinusDays extends AbstractFunction {

    private static final Logger LOG = LoggingManager.getLoggerForClass();

    private static final String KEY = "__MinusDays";
    ...
    private static final int DAYS_PARAM = 1;
    ...
    public String execute(SampleResult sampleResult, Sampler sampler) throws InvalidVariableException {
        ...
        final int days = Integer.valueOf(values.get(DAYS_PARAM));
    ...
    public List<String> getArgumentDesc() {
        return Arrays.asList("Date string format (yyyy-MM-dd)","Number of days to subtract");
    }
}
