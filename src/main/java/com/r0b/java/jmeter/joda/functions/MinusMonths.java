 ...
 */
public class MinusMonths extends AbstractFunction {

    private static final Logger LOG = LoggingManager.getLoggerForClass();

    private static final String KEY = "__MinusMonths";
    ...
    private static final int MONTHS_PARAM = 1;
    ...
    public String execute(SampleResult sampleResult, Sampler sampler) throws InvalidVariableException {
        ...
        final int months = Integer.valueOf(values.get(MONTHS_PARAM));
        final LocalDate date = new LocalDate(dateString);
        return date.minusMonths(months).toString();
    }
    ...
    public List<String> getArgumentDesc() {
        return Arrays.asList("Date string format (yyyy-MM-dd)", "Number of months to subtract");
    }
}
